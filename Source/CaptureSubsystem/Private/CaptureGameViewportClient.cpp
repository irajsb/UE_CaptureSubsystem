...
void UCaptureGameViewportClient::Draw(FViewport* InViewport, FCanvas* Canvas)
{
	...
	if(!MyRenderTarget)
	{
		...
		MyRenderTarget->RenderTargetFormat = ETextureRenderTargetFormat::RTF_RGB10A2;
...
void UCaptureGameViewportClient::CopyTextureRHI(FRenderTarget* MyViewRenderTarget, UTextureRenderTarget2D* DestRenderTarget)
{
